...
def test_increments_shown_count_and_persists_other_fields_unchanged():
    ...
    result = IncrementShownCount(repo).execute(Email("igor.carneiro@gmail.com"), "english", "en-0001")
...
def test_raises_for_word_not_assigned_to_user():
    ...
    with pytest.raises(WordNotAssignedError):
        IncrementShownCount(repo).execute(Email("igor.carneiro@gmail.com"), "english", "en-9999")
