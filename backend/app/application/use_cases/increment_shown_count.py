...
class IncrementShownCount:
    def __init__(self, progress_repository: ProgressRepository) -> None:
        self._progress_repository = progress_repository

    def execute(self, email: Email, lang: LanguagePair, word_id: str) -> int:
        ...
        updated = replace(record, shown_count=record.shown_count + 1)
        self._progress_repository.upsert_progress(email, lang, updated)
        return updated.shown_count
