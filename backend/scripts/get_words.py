...
Example:
    python backend/scripts/get_words.py pt 1 1 2 4
"""
...
def get_words(data, start_chapter, start_topic, end_chapter, end_topic):
    ...
    return [word for _, words in breakdown for word in words]
...
def main():
    ...
    words = get_words(data, start_chapter, start_topic, end_chapter, end_topic)
